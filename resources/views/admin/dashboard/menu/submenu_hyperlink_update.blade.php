...
@section('content')
    ...
    <div class="page-body">
        <div class="container-xl">
            <div class="row">
                <form action="/update-submenu/{{ $submenu->id }}" method="POST">
                    @method('PUT')
                    @csrf
                        ...
                        <div class="tab-pane active" id="id">
                            <div class="mb-3">
                                <input type="text" class="form-control @error('url') is-invalid @enderror" id="url"
                                    name="url" placeholder="Masukkan url /" value="{{ $submenu->url }}">
                                @error('url')
                            ...
                            <div class="mb-3">
                                <input type="text" class="form-control @error('name') is-invalid @enderror"
                                    id="name" name="name" placeholder="Masukkan nama" value="{{ $submenu->name }}">
                                @error('name')
                                    <div class="invalid-feedback">
