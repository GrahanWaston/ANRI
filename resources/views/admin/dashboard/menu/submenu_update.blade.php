...
@section('content')
    ...
    <div class="page-body">
        <div class="container-xl">
            <div class="row">
                <form action="/manajemen-sub-menu/{{ $submenus->id }}" method="POST">
                    @method('PUT')  
                    @csrf
                        ...
                        <div class="tab-pane active" id="id">
                            <div class="mb-3">
                                <input type="text" class="form-control @error('url') is-invalid @enderror" id="url"
                                    name="url" placeholder="Masukkan url /" value="{{ old('url') ?? $submenus->url }}">
                                @error('url')
                            ...
                            <div class="card border-0 shadow-none mb-3">
                                <div class="form-group">
                                    <textarea class="tinymce-editor @error('body') is-invalid @enderror" id="editortiny" name="body">{{ old('body') ?? $submenus->body }}</textarea>
                                    @error('body')
                                        <div class="invalid-feedback">
