    ...
    <div class="page-header d-print-none">
        <div class="row align-items-center">
            ...
            <div class="col-auto d-print-none">
                <div class="btn-list">
                    <a href="/profil-pejabat/SDM/create" class="btn btn-primary d-inline-block">
                        <i class="fa fa-plus me-2"></i> Pejabat / SDM
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="card">
            <div class="table-responsive">
                ...
                <table class="table card-table table-post" id="myTable">
                    ...
                    <tbody>
                        @foreach ($SDM as $pejabat)
                        <tr>
                            <td><input type="checkbox"></td>
                            <td>
                                <div class="btn-group">
                                    <a href="/profil-pejabat/SDM/{{ $pejabat->id}}/edit " class="btn btn-light m-1 h3 text-primary" title="Edit"><i class="fas fa-file-signature"></i></a>
                                    @if ($pejabat->status == 'published')
                                                ...
                                                @endif
                                    <form action="{{ route('SDM.destroy', $pejabat->id) }}"
...
<script type="text/javascript">
    $(function() {
        $('#navbar-menu > .navbar-nav > .nav-item > .nav-link > .nav-link-title:contains("Profil Pejabat - SDM")').parents('.nav-item').addClass('active').find('.dropdown-menu').addClass('show').find('.dropdown-item:contains("Profil")').addClass('active');
    });
</script>
