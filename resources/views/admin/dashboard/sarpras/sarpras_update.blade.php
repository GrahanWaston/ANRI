...
@section('content')
    ...
    <div class="page-body">
        <div class="container-xl">
            <div class="row">
                <form action="/sarana-prasarana/{{ $data_sarpras->id }}" method="POST" enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                ...
                                <img class="img-fluid" style="height: auto!important;"
                                    src="{{ asset('storage/' . $data_sarpras->image) }}" alt="">
                                <div class="mb-3">
                                    <div class="form-label">Foto</div>
                                    <input type="file" class="form-control @error('image') is-invalid @enderror" accept=".jpg,.jpeg,.png," name="image">
                                    @error('image')
                                        <div class="invalid-feedback">
                ...
                $('.btn-publish').on('click', function() {
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            Swal.fire(
                                'Success!',
                                'Prasarana & Sarana Berhasil ditambah',
                                'success',
                            ).then((result) => {
                                window.location = "?page=sarana-prasarana";
                            })
                        }
                    })
                });
        ...
        <script type="text/javascript">
            $(function() {
                $('#navbar-menu > .navbar-nav > .nav-item > .nav-link > .nav-link-title:contains("Prasarana & Sarana")')
