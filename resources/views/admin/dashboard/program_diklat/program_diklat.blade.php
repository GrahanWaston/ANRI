        ...
        <div class="page-header d-print-none">
            <div class="row align-items-center">
                ...
                <div class="col-auto d-print-none">
                    <div class="btn-list">
                        <a href="/program-diklat/create" class="btn btn-primary d-inline-block">
                            <i class="fa fa-plus me-2"></i> Program
                        </a>
                    </div>
                </div>
            </div>
        ...
        $(function() {
            $('#navbar-menu > .navbar-nav > .nav-item > .nav-link > .nav-link-title:contains("Program Diklat")')
                .parents('.nav-item').addClass('active').find('.dropdown-menu').addClass('show').find(
                    '.dropdown-item:contains("Program Diklat")').addClass('active');
        });
    </script>
