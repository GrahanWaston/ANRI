...
@section('content')
    ...
    <div class="page-body">
        <div class="container-xl">
            <div class="row">
                <form action="/program-diklat/{{ $data_program->id }}" method="POST" enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('kode_diklat') is-invalid @enderror"
                                        ...
                                        value="{{ old('kode_diklat') ?? $data_program->kode_diklat }}">
                                    @error('kode_diklat')
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="jenis_id"
                                        ...
                                        <option value="" disabled="" selected>
                                            {{ $data_program->jenis->nama_jenis }}</option>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="jenjang_id"
                                        ...
                                        <option value="" disabled="" selected>{{ $data_program->jenjang->jenjang }}
                                        </option>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('nama_diklat') is-invalid @enderror"
                                        ...
                                        value="{{ old('nama_diklat') ?? $data_program->nama_diklat }}">
                                    @error('nama_diklat')
                                        <div class="invalid-feedback">
                                ...
                                <div class="input-icon mb-3">
                                    ...
                                    <div class="input-group date " id="datepicker">
                                        <input type="text" class="form-control @error('start_date') is-invalid @enderror"
                                            ...
                                            value="{{ old('start_date') ?? $data_program->start_date }}">
                                        ...
                                        @error('start_date')
                                            <div class="invalid-feedback">
                                                Jadwal Mulai harus di isi terlebih dahulu!
                                            </div>
                                        @enderror
                                    </div>
                                </div>
                                <div class="input-icon mb-3">
                                    ...
                                    <div class="input-group date" id="enddatepicker">
                                        <input type="text" class="form-control @error('end_date') is-invalid @enderror"
                                            id="end_date" name="end_date" value="{{ old('end_date') ?? $data_program->end_date }}">
                                        <span class="input-group-append">
                                            <span class="input-group-text bg-light d-block">
                                                <i class="fa fa-calendar"></i>
                                            </span>
                                        ...
                                        @error('end_date')
                                            <div class="invalid-feedback">
                                                Jadwal selesai harus di isi terlebih dahulu!
                                            </div>
                                        @enderror
                                    </div>
                                </div>
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('tempat_diklat') is-invalid @enderror"
                                        id="tempat_diklat" name="tempat_diklat" value="{{ old('tempat_diklat') ?? $data_program->tempat_diklat }}">
                                    @error('tempat_diklat')
                                        <div class="invalid-feedback">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('biaya') is-invalid @enderror"
                                        id="biaya" name="biaya" value="{{ old('biaya') ?? $data_program->biaya }}">
                                    @error('biaya')
                                        <div class="invalid-feedback">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('durasi') is-invalid @enderror"
                                        id="durasi" name="durasi" value="{{ old('durasi') ?? $data_program->durasi }}">
                                    @error('durasi')
                                        <div class="invalid-feedback">
                                            Durasi harus di isi terlebih dahulu!
                                        </div>
                                    @enderror
                                </div>
                                <div class="mb-3">
                                    ...
                                    @error('file')
                                        <div class="invalid-feedback">
                                            File harus di isi terlebih dahulu dan di sesuaikan formatnya!
                                        </div>
                                    @enderror
                                    <div class="form-text">
                                        File type : .pdf,.docx
                                ...
                                <div class="card border-0 shadow-none mb-3">
                                    <div class="form-group">
                                        <textarea class="tinymce-editor @error('deskripsi') is-invalid @enderror" id="editortiny" name="deskripsi">{{ old('deskripsi') ?? $data_program->deskripsi }}</textarea>
                                        @error('deskripsi')
                                            <div class="invalid-feedback">
