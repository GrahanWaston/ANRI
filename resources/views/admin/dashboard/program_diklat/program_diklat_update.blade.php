                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('kode_diklat') is-invalid @enderror"
                                        id="kode_diklat" name="kode_diklat" value="{{ $data_program->kode_diklat }}">
                                    @error('kode_diklat')
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('nama_diklat') is-invalid @enderror"
                                        id="nama_diklat" name="nama_diklat" value="{{ $data_program->nama_diklat }}">
                                    @error('nama_diklat')
                                        <div class="invalid-feedback">
                                ...
                                <div class="input-icon mb-3">
                                    ...
                                    <div class="input-group date" id="enddatepicker">
                                        <input type="text" class="form-control @error('end_date') is-invalid @enderror"
                                            id="end_date" name="end_date" value="{{ $data_program->end_date }}">
                                        <span class="input-group-append">
                                            <span class="input-group-text bg-light d-block">
                                                <i class="fa fa-calendar"></i>
                                            </span>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('tempat_diklat') is-invalid @enderror"
                                        id="tempat_diklat" name="tempat_diklat" value="{{ $data_program->tempat_diklat }}">
                                    @error('tempat_diklat')
                                        <div class="invalid-feedback">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('biaya') is-invalid @enderror"
                                        id="biaya" name="biaya" value="{{ $data_program->biaya }}">
                                    @error('biaya')
                                        <div class="invalid-feedback">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('durasi') is-invalid @enderror"
                                        id="durasi" name="durasi" value="{{ $data_program->durasi }}">
                                    @error('durasi')
                                        <div class="invalid-feedback">
                                ...
                                <div class="card border-0 shadow-none mb-3">
                                    <div class="form-group">
                                        <textarea class="tinymce-editor @error('deskripsi') is-invalid @enderror" id="editortiny" name="deskripsi">{{ $data_program->deskripsi }}</textarea>
                                        @error('deskripsi')
                                            <div class="invalid-feedback">
