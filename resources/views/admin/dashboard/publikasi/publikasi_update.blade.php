...
@section('content')
    ...
    <div class="page-body">
        <div class="container-xl">
            ...
            <div class="row">
                <form action="/publikasi/{{ $data_publication->id }}" method="POST" enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
                    <div class="col-md-8 mb-4 mb-md-0">
                        ...
                        <div class="card border-0 shadow-none mb-3">
                            <div class="form-group">
                                <textarea class="tinymce-editor @error('body') is-invalid @enderror" id="editortiny" name="body">{!! $data_publication->body !!}</textarea>
                                @error('body')
                                        <div class="invalid-feedback">
                                            Kategori harus di isi terlebih dahulu!
                                        </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="card mb-3">
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    <div class="form-label">Upload Image</div>
                                    <input type="file" class="form-control @error('image_album') is-invalid @enderror" id="image_album" name="image_album"
                                        multiple>
                                    @error('image_album')
                                        <div class="invalid-feedback">
                                            Foto album harus di isi terlebih dahulu!
                                        </div>
                                    @enderror
                                    <div class="form-text">
                                        File type : PNG, JPG, JPEG, rekomendasi ukuran 400x300
