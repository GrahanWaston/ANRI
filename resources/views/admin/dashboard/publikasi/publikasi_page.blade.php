                        ...
                        <tbody>
                            @foreach ($publication as $publications)
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            <a href="/publikasi/{{ $publications->id }}/edit"
                                                class="btn btn-light m-1 h3 text-primary"><i
                                                    class="fas fa-file-signature"></i></a>
                                            @if (auth()->user()->role == 'admin')
                                                @if ($publications->status == 'draft' || $publications->status == '')
                                                    <form action="/approve-publikasi/{{ $publications->id }}" method="POST"
                                                        class="d-inline">
                                                        @method('PUT')
                                                        @csrf
                                                ...
                                                @else
                                                    <form action="/unapprove-publikasi/{{ $publications->id }}"
                                                ...
                                                @endif
                                            @endif
                                            <form action="{{ route('publikasi.destroy', $publications->id) }}"
                                                method="POST" class="d-inline">
                                                @method('delete')
                                                @csrf
                                                <button type="submit" class="btn btn-light m-1 h3 text-danger">
