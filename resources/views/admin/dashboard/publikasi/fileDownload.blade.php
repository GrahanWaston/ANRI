    ...
    <script>
        ...
        $(document).on('click', 'button#destroy', function() {
            ...
            if (files.length > 0) {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        let url = '{{ route('publikasi-file.delete') }}';
                        $.ajax({
                            url: url,
                            type: "delete",
                            data: {
        ...
        $(document).on('click', 'button#approve', function() {
            ...
            if (files.length > 0) {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        let url = '{{ route('approve-file-mass') }}';
                        $.ajax({
                            url: url,
                            type: "put",
                            data: {
        ...
        $(document).on('click', 'button#unapprove', function() {
            ...
            if (files.length > 0) {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        let url = '{{ route('unapprove-file-mass') }}';
                        $.ajax({
                            url: url,
                            type: "put",
                            data: {
        ...
        $(document).on("click", '.unapproval', function() {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    let url = '{{ route('unapprove-file', ':id') }}';
                    url = url.replace(':id', id);
                    console.log(url);
                    $.ajax({
                        url: url,
        ...
        $(document).on("click", '.delete', function() {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    let url = '{{ route('publikasi-file.destroy', ':id') }}';
                    url = url.replace(':id', id);
                    console.log(url);
                    $.ajax({
                        url: url,
